(function umd(require) {
	...
	6: [function (require, module, exports) {
		...
		Analytics.prototype._parseQuery = function () {
			...
			if (q.ajs_uid) {
				this.identify(q.ajs_uid);
			}
			if (q.ajs_event) {
				this.track(q.ajs_event);
			}
			if (q.ajs_aid) {
	...
	45: [function (require, module, exports) {
		...
		exports.is = function (string, strict) {
			if (strict && false === /^\d{4}-\d{2}-\d{2}/.test(string)) {
				return false;
			}
...
// This requires a wrapper element in IE
	...
	125: [function (require, module, exports) {
		...
		KISSmetrics.prototype.track = function (track) {
			...
			if (this.options.prefixProperties) {
...
// `{"Segment.io":{"apiKey":"gjQrsIN0eZfCmxzB1SMX7TMlEKTCLUbi","addBundledMetadata":true,"unbundledIntegrations":[]}}` and `{"track":{}}` using project settings.
			analytics.initialize({"Segment.io": {"apiKey": "gjQrsIN0eZfCmxzB1SMX7TMlEKTCLUbi", "addBundledMetadata": true, "unbundledIntegrations": []}}, {
...
// `global.require`
		...
		}).call(this, typeof window !== "undefined" && window.document && window.document.implementation ? window :
			typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : {})
	}, {"./analytics": 6, "./integrations": 3}]
}, {}, {"200": ""}));